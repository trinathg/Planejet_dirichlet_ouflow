const int DIM=2;
const int NUM_VAR=7;     // U, V, P,H0,H1 corresponding to the indices 0, 1, 2, 3, 4; Here 3 & 4 correspond to advective + viscous fluxes in both the directions; 5 & 6 will corrsespond to U and V at n-1 time level. 
...
const double l_y = 32.0;    //The height of the 2D channel  
const double l_x = 64.0; //Non dimensional units 
const double delta_p = 2.0; //This is the difference between the outlet and inlet pressure. The flow is from left to right

const double Re = 1000.0; //Reynolds number based on the size of the cavity 
const double RRe = 1./Re;  	
//const double RRe = 0.0; 

const double dx = l_x/nx; //The grid spacing in X and Y-directions 
const double dy = l_y/ny; 

const double delta = 0.1; //The small parameter in the outflow BC from Dong's paper. 

//const double dt = 5.0e-4; //CFL_d*(dx)*(dx)*Re; // 1/Re acts as a diffusion coefficient here 

const double beta_cfl = 0.5;	
const double u_max = 1.0; 
const double dt = beta_cfl*min(dx,dy)/u_max; 

const double tot_time = 100.0; //Some-non-dimenisonal time 
...
extern std::vector<double> dX1,dX2,dX3,dX4,dX5,dX6; 
extern std::vector<double> Y1,Y2,Y3,Y4,Y5,Y6,Y7;
extern std::vector<double> dY1,dY2,dY3,dY4,dY5,dY6;
...
extern std::vector<double> ddc_b1_11, ddc_b1_12, ddc_b1_13, ddc_nb1_21, ddc_nb1_22, ddc_nb1_23, ddc_nb1_24;
...
extern std::vector<double> ddc_b2_11, ddc_b2_12, ddc_b2_13, ddc_nb2_21, ddc_nb2_22, ddc_nb2_23, ddc_nb2_24; 
...
extern std::vector<double> ddc_b3_11, ddc_b3_12, ddc_b3_13, ddc_nb3_21, ddc_nb3_22, ddc_nb3_23, ddc_nb3_24; 
...
extern std::vector<double> ddc_b4_11, ddc_b4_12, ddc_b4_13, ddc_nb4_21, ddc_nb4_22, ddc_nb4_23, ddc_nb4_24;
...
extern std::vector<double> ddc_b5_11, ddc_b5_12, ddc_b5_13, ddc_nb5_21, ddc_nb5_22, ddc_nb5_23, ddc_nb5_24;
...
extern std::vector<double> ddc_b6_11, ddc_b6_12, ddc_b6_13, ddc_nb6_21, ddc_nb6_22, ddc_nb6_23, ddc_nb6_24; 
...
extern std::vector<double> ddc_b7_11, ddc_b7_12, ddc_b7_13, ddc_nb7_21, ddc_nb7_22, ddc_nb7_23, ddc_nb7_24;
...
extern std::vector<double> ddc_b8_11, ddc_b8_12, ddc_b8_13, ddc_nb8_21, ddc_nb8_22, ddc_nb8_23, ddc_nb8_24;
...
extern std::vector<double> ddc_b9_11, ddc_b9_12, ddc_b9_13, ddc_nb9_21, ddc_nb9_22, ddc_nb9_23, ddc_nb9_24;
...
extern std::vector<double> ddc_b10_11, ddc_b10_12, ddc_b10_13, ddc_nb10_21, ddc_nb10_22, ddc_nb10_23, ddc_nb10_24;
...
extern std::vector<double> ddc_b11_11, ddc_b11_12, ddc_b11_13, ddc_nb11_21, ddc_nb11_22, ddc_nb11_23, ddc_nb11_24;
...
extern std::vector<double> ddc_b12_11, ddc_b12_12, ddc_b12_13, ddc_nb12_21, ddc_nb12_22, ddc_nb12_23, ddc_nb12_24;

...
vector<double> dX1(mg_levels),dX2(mg_levels),dX3(mg_levels),dX4(mg_levels),dX5(mg_levels),dX6(mg_levels); 

vector<double> Y1(mg_levels),Y2(mg_levels),Y3(mg_levels),Y4(mg_levels),Y5(mg_levels),Y6(mg_levels),Y7(mg_levels);
vector<double> dY1(mg_levels),dY2(mg_levels),dY3(mg_levels),dY4(mg_levels),dY5(mg_levels),dY6(mg_levels);
...
vector<double> ddc_b1_11(mg_levels), ddc_b1_12(mg_levels), ddc_b1_13(mg_levels), ddc_nb1_21(mg_levels), ddc_nb1_22(mg_levels), ddc_nb1_23(mg_levels), ddc_nb1_24(mg_levels);
...
vector<double> ddc_b2_11(mg_levels), ddc_b2_12(mg_levels), ddc_b2_13(mg_levels), ddc_nb2_21(mg_levels), ddc_nb2_22(mg_levels), ddc_nb2_23(mg_levels), ddc_nb2_24(mg_levels);
...
vector<double> ddc_b3_11(mg_levels), ddc_b3_12(mg_levels), ddc_b3_13(mg_levels), ddc_nb3_21(mg_levels), ddc_nb3_22(mg_levels), ddc_nb3_23(mg_levels), ddc_nb3_24(mg_levels);
...
vector<double> ddc_b4_11(mg_levels), ddc_b4_12(mg_levels), ddc_b4_13(mg_levels), ddc_nb4_21(mg_levels), ddc_nb4_22(mg_levels), ddc_nb4_23(mg_levels), ddc_nb4_24(mg_levels);
...
vector<double> ddc_b5_11(mg_levels), ddc_b5_12(mg_levels), ddc_b5_13(mg_levels), ddc_nb5_21(mg_levels), ddc_nb5_22(mg_levels), ddc_nb5_23(mg_levels), ddc_nb5_24(mg_levels);
...
vector<double> ddc_b6_11(mg_levels), ddc_b6_12(mg_levels), ddc_b6_13(mg_levels), ddc_nb6_21(mg_levels), ddc_nb6_22(mg_levels), ddc_nb6_23(mg_levels), ddc_nb6_24(mg_levels);
...
vector<double> ddc_b7_11(mg_levels), ddc_b7_12(mg_levels), ddc_b7_13(mg_levels), ddc_nb7_21(mg_levels), ddc_nb7_22(mg_levels), ddc_nb7_23(mg_levels), ddc_nb7_24(mg_levels);
...
vector<double> ddc_b8_11(mg_levels), ddc_b8_12(mg_levels), ddc_b8_13(mg_levels), ddc_nb8_21(mg_levels), ddc_nb8_22(mg_levels), ddc_nb8_23(mg_levels), ddc_nb8_24(mg_levels);
...
vector<double> ddc_b9_11(mg_levels), ddc_b9_12(mg_levels), ddc_b9_13(mg_levels), ddc_nb9_21(mg_levels), ddc_nb9_22(mg_levels), ddc_nb9_23(mg_levels), ddc_nb9_24(mg_levels); 
...
vector<double> ddc_b10_11(mg_levels), ddc_b10_12(mg_levels), ddc_b10_13(mg_levels), ddc_nb10_21(mg_levels), ddc_nb10_22(mg_levels), ddc_nb10_23(mg_levels), ddc_nb10_24(mg_levels);
...
vector<double> ddc_b11_11(mg_levels), ddc_b11_12(mg_levels), ddc_b11_13(mg_levels), ddc_nb11_21(mg_levels), ddc_nb11_22(mg_levels), ddc_nb11_23(mg_levels), ddc_nb11_24(mg_levels);
...
vector<double> ddc_b12_11(mg_levels), ddc_b12_12(mg_levels), ddc_b12_13(mg_levels), ddc_nb12_21(mg_levels), ddc_nb12_22(mg_levels), ddc_nb12_23(mg_levels), ddc_nb12_24(mg_levels); 
...
void mg_coeff()
{
	...
	{	
		...
		/****Neumann Coefficients after BCs are accommodated***/
		...
		/***Changed coefficients used for Dirichlet BCs only****/
		
		dX1[lev] = hxx[lev]; 
		dX2[lev] = -2.*a_nb*hyy[lev]; 
		
		dX3[lev] = alpha_nb*hxx[lev];
		dX4[lev] = a_nb*hyy[lev]; 
		
		dX5[lev] = 0.0;
		dX6[lev] = 0.0; 

		dY1[lev] = alpha*hxx[lev];
		dY2[lev] = a*hyy[lev]; 
		
		dY3[lev] = hxx[lev]; 
		dY4[lev] = -2.*(a+b)*hyy[lev]; 
		
		dY5[lev] = alpha*hxx[lev]; 
		dY6[lev] = a*hyy[lev];			
		...
		ddc_b1_11[lev] = -2.*X1[lev]*a_nb + X2[lev];   //For the Dirichlet side of the boundary
		ddc_b1_12[lev] = X1[lev]*a_nb + X2[lev]*alpha_nb; 
		ddc_b1_13[lev] = 0.0;	
		...
		ddc_nb1_21[lev] = X1[lev]*a + X2[lev]*alpha; //For the Dirichlet side of the boundary
		ddc_nb1_22[lev] = -2.*(a+b)*X1[lev] + X2[lev]; 
		ddc_nb1_23[lev] = X1[lev]*a + X2[lev]*alpha; 
		ddc_nb1_24[lev] = X1[lev]*b; 
		...
		ddc_b2_11[lev] = -2.*X3[lev]*a_nb + X4[lev]; //For the Dirichlet side of the boundary
		ddc_b2_12[lev] = X3[lev]*a_nb + X4[lev]*alpha_nb;
		ddc_b2_13[lev] = 0.0;
		...
		ddc_nb2_21[lev] = X3[lev]*a + X4[lev]*alpha; //For the Dirichlet side of the boundary
		ddc_nb2_22[lev] = -2.*(a+b)*X3[lev] + X4[lev];
		ddc_nb2_23[lev] = X3[lev]*a + X4[lev]*alpha;
		ddc_nb2_24[lev] = X3[lev]*b;
		...
		ddc_b3_11[lev] = -2.*X5[lev]*a_nb + X6[lev] ;  //For the Dirichlet side of the boundary
		ddc_b3_12[lev] = X5[lev]*a_nb + X6[lev]*alpha_nb ;
		ddc_b3_13[lev] = 0.0;
		...
		ddc_nb3_21[lev] = X5[lev]*a + X6[lev]*alpha;	//For the Dirichlet side of the boundary
		ddc_nb3_22[lev] = -2.*(a+b)*X5[lev] + X6[lev];
		ddc_nb3_23[lev] = X5[lev]*a + X6[lev]*alpha;
		ddc_nb3_24[lev] = X5[lev]*b;
		...
		ddc_b4_11[lev] = -2.*Y1[lev]*a_nb + Y2[lev];  //For the Dirichlet part of the boundary
		ddc_b4_12[lev] = Y1[lev]*a_nb + Y2[lev]*alpha_nb; 
		ddc_b4_13[lev] = 0.0; 
		...
		ddc_nb4_21[lev] = Y1[lev]*a + Y2[lev]*alpha; //For the Dirichlet part of the boundary
		ddc_nb4_22[lev] = -2.*(a+b)*Y1[lev] + Y2[lev]; 
		ddc_nb4_23[lev] = Y1[lev]*a + Y2[lev]*alpha; 
		ddc_nb4_24[lev] = Y1[lev]*b; 
		...
		ddc_b5_11[lev] = -2.*Y3[lev]*a_nb + Y4[lev]; 
		ddc_b5_12[lev] = Y3[lev]*a_nb + Y4[lev]*alpha_nb; 
		ddc_b5_13[lev] = 0.0; 
		...
		ddc_nb5_21[lev] = Y3[lev]*a + Y4[lev]*alpha; 
		ddc_nb5_22[lev] = -2.*(a+b)*Y3[lev] + Y4[lev]; 
		ddc_nb5_23[lev] = Y3[lev]*a + Y4[lev]*alpha; 
		ddc_nb5_24[lev] = Y3[lev]*b; 
		...
		ddc_b6_11[lev] = -2.*Y5[lev]*a_nb + Y6[lev]; //For the Dirichlet side of the boundary
		ddc_b6_12[lev] = Y5[lev]*a_nb + Y6[lev]*alpha_nb; 
		ddc_b6_13[lev] = 0.0; 
		...
		ddc_nb6_21[lev] = Y5[lev]*a + Y6[lev]*alpha; //For the Dirichlet side of the boundary
		ddc_nb6_22[lev] = -2.*(a+b)*Y5[lev] + Y6[lev]; 
		ddc_nb6_23[lev] = Y5[lev]*a + Y6[lev]*alpha; 
		ddc_nb6_24[lev] = Y5[lev]*b; 
		...
		ddc_b7_11[lev] =  Y7[lev]; //For the Dirichlet side of the boundary
		ddc_b7_12[lev] =  Y7[lev]*alpha_nb; 
		ddc_b7_13[lev] =  0.0; 
		...
		ddc_b8_11[lev] =  YB[lev]; //For the Dirichlet side of the boundary
		ddc_b8_12[lev] =  YB[lev]*alpha_nb; 
		ddc_b8_13[lev] =  0.0; 
		...
		ddc_b9_11[lev] = -2.*XA[lev]*a_nb + YA[lev]; //For the Dirichlet side of the boundary
		ddc_b9_12[lev] = XA[lev]*a_nb + YA[lev]*alpha_nb; 
		ddc_b9_13[lev] = 0.0; 
		...
		ddc_nb9_21[lev] = XA[lev]*a + YA[lev]*alpha; //For the Dirichlet side of the boundary
		ddc_nb9_22[lev] = -2.*(a+b)*XA[lev] + YA[lev]; 
		ddc_nb9_23[lev] = XA[lev]*a + YA[lev]*alpha; 
		ddc_nb9_24[lev] = XA[lev]*b; 
		...
		ddc_b10_11[lev] = -2.*XH[lev]*a_nb + YH[lev] ; //For the Dirichlet side of the boundary
		ddc_b10_12[lev] = XH[lev]*a_nb + YH[lev]*alpha_nb ; 
		ddc_b10_13[lev] = 0.0; 
		...
		ddc_nb10_21[lev] = XH[lev]*a + YH[lev]*alpha; //For the Dirichlet side of the boundary
		ddc_nb10_22[lev] = -2.*(a+b)*XH[lev] + YH[lev]; 
		ddc_nb10_23[lev] = XH[lev]*a + YH[lev]*alpha; 
		ddc_nb10_24[lev] = XH[lev]*b; 
		...
		ddc_b11_11[lev] = -2.*XA[lev]*a_nb + YA[lev]; //For the Dirichlet side of the boundary
		ddc_b11_12[lev] = XA[lev]*a_nb + YA[lev]*alpha_nb; 
		ddc_b11_13[lev] = 0.0; 
		...
		ddc_nb11_21[lev] = XA[lev]*a + YA[lev]*alpha; //For the Dirichlet side of the boundary
		ddc_nb11_22[lev] = -2.*(a+b)*XA[lev] + YA[lev]; 
		ddc_nb11_23[lev] = XA[lev]*a + YA[lev]*alpha; 
		ddc_nb11_24[lev] = XA[lev]*b; 
		...
		ddc_b12_11[lev] =  YB[lev]; //For the Dirichlet side of the boundary
		ddc_b12_12[lev] =  YB[lev]*alpha_nb; 
		ddc_b12_13[lev] =  0.0; 
...
{   
  ...
  /*ofstream mg_rhsy, mg_rhsx; 
  
  mg_rhsy.open("rhs_dp_dy.dat");   
  mg_rhsx.open("rhs_dpdx_plus_dpdy.dat");*/   
  ...
  for(int i=st_inx;i<=en_inx;i=i+sp)
  {
    ...
    {        
      ...
      else if(i==en_inx-sp)
      {
     	...
     	//extra = extra_pol(nx-5*sp, 0,level,lev);        
     	
     	//extra = p2x[0]; //Dirichlet boundary value
  ...
  for(int i=st_inx;i<=en_inx;i=i+sp) 
  {
    ...
    else if(i>=st_inx+sp && i<=en_inx-sp)
    {
      ...
      else if(i==en_inx-sp)
      {
        ...
        //extra = p2x[0]; //The Dirichlet boundary value.
  ...
  for(int i=st_inx;i<=en_inx;i=i+sp) 
  {
    ...
    if(i==st_inx)
    {
        ...
        //extra = extra_pol(0, ny-5*sp,level,lev);        
	...
	//extra = extra_pol(nx-5*sp, ny-5*sp,level,lev);         
	
	//extra = p2x[ny]; //Dirichlet boundary value.
  ...
  for(int i=st_inx;i<=en_inx;i=i+sp)
  {
    ...
    if(i==en_inx-sp)
    {
      ...
      level[lev].cor_rhs[ind] = level[lev].cor_rhs[ind] - X1[lev]*b*p2x[j] - X3[lev]*b*p2x[j+sp] - X5[lev]*b*p2x[j+2*sp];     
    }
    ...
    if(i==en_inx)
    {
      ...
      //level[lev].cor_rhs[ind] = level[lev].cor_rhs[ind];            
      
      level[lev].cor_rhs[ind] = level[lev].cor_rhs[ind] - (X1[lev]*a_nb + X2[lev]*alpha_nb)*p2x[j] - (X3[lev]*a_nb + X4[lev]*alpha_nb)*p2x[j+sp] - (X5[lev]*a_nb + X6[lev]*alpha_nb)*p2x[j+2*sp]  ; 
    }
  ...
  for(int i=st_inx;i<=en_inx;i=i+sp)
  {
    ...
    if(i==en_inx-sp)
    {
      ...
      //level[lev].cor_rhs[ind] = level[lev].cor_rhs[ind]; //Only Dirichlet boundary here. But the value is zero.             
      
      level[lev].cor_rhs[ind] = level[lev].cor_rhs[ind] - Y1[lev]*b*p2x[j-sp] - Y3[lev]*b*p2x[j] - Y5[lev]*b*p2x[j+sp]; 
    }
    ...
    if(i==en_inx)
    {
      ...
      level[lev].cor_rhs[ind] = level[lev].cor_rhs[ind] - (Y1[lev]*a_nb + Y2[lev]*alpha_nb)*p2x[j-sp] - (Y3[lev]*a_nb + Y4[lev]*alpha_nb)*p2x[j] - (Y5[lev]*a_nb + Y6[lev]*alpha_nb)*p2x[j+sp] - Y7[lev]*alpha_nb*p2x[j+2*sp] ;            
    }
  ...
  for(int j=st_iny+2*sp;j<=en_iny-2*sp;j=j+sp)
  {
	...
	//level[lev].cor_rhs[ind] = level[lev].cor_rhs[ind]; //Dirichlet boundary. Value is zero. 		
	
	level[lev].cor_rhs[ind] = level[lev].cor_rhs[ind] - XA[lev]*b*p2x[j-sp] - XH[lev]*b*p2x[j] - XA[lev]*b*p2x[j+sp]; 
      }
	...
	level[lev].cor_rhs[ind] = level[lev].cor_rhs[ind] - (YB[lev]*alpha_nb)*p2x[j-2*sp] - (XA[lev]*a_nb + YA[lev]*alpha_nb)*p2x[j-sp] - (XH[lev]*a_nb + YH[lev]*alpha_nb)*p2x[j] - (XA[lev]*a_nb + YA[lev]*alpha_nb)*p2x[j+sp] - (YB[lev]*alpha_nb)*p2x[j+2*sp]  ;
      }
...
/********************************************************************/
//Direct solver required for the solution on the coarsest grid. 
void arma_direct_solve(mg_grid * level, int lev)
{
	...
	for(int j=sp;j<ny;j=j+sp)
	{
		for(int i=sp;i<nx;i=i+sp)
		{
			...
			if(j==st_iny)
			{
			  ...
			  {    			     			    
			    A(ind_m,ind_m-2) = ddc_nb1_24[lev];
    			    A(ind_m,ind_m-1) = ddc_nb1_23[lev]; 
			    A(ind_m,ind_m) = ddc_nb1_22[lev]; 
			    A(ind_m,ind_m+1) = ddc_nb1_21[lev]; 
			    
			    A(ind_m,ind_m-2+str_m) = ddc_nb2_24[lev]; 
			    A(ind_m,ind_m-1+str_m) = ddc_nb2_23[lev]; 
			    A(ind_m,ind_m+str_m) = ddc_nb2_22[lev]; 
			    A(ind_m,ind_m+1+str_m) = ddc_nb2_21[lev];	    
			    
			    A(ind_m,ind_m-2+2*str_m) = ddc_nb3_24[lev];	  
			    A(ind_m,ind_m-1+2*str_m) = ddc_nb3_23[lev]; 
			    A(ind_m,ind_m+2*str_m) = ddc_nb3_22[lev]; 
			    A(ind_m,ind_m+1+2*str_m) = ddc_nb3_21[lev]; 			    		    
			  }
			  else 
			  {		    				    
			    A(ind_m,ind_m) = ddc_b1_11[lev]; 
			    A(ind_m,ind_m-1) = ddc_b1_12[lev]; 
			    A(ind_m,ind_m-2) = ddc_b1_13[lev]; 
			    
			    A(ind_m,ind_m+str_m) = ddc_b2_11[lev]; 
			    A(ind_m,ind_m-1+str_m) = ddc_b2_12[lev]; 
			    A(ind_m,ind_m-2+str_m) = ddc_b2_13[lev]; 
			    
			    A(ind_m,ind_m+2*str_m) = ddc_b3_11[lev]; 
			    A(ind_m,ind_m-1+2*str_m) = ddc_b3_12[lev]; 
			    A(ind_m,ind_m-2+2*str_m) = ddc_b3_13[lev];	    
			  }	  	
			}
			...
			if(j==st_iny+sp)
			{
			  ...
			  {	    			       
			    A(ind_m,ind_m+1-str_m) = ddc_nb4_21[lev]; 
			    A(ind_m,ind_m-str_m) = ddc_nb4_22[lev]; 
			    A(ind_m,ind_m-1-str_m)= ddc_nb4_23[lev]; 
			    A(ind_m,ind_m-2-str_m) = ddc_nb4_24[lev]; 
			    
			    A(ind_m,ind_m+1) = ddc_nb5_21[lev]; 
			    A(ind_m,ind_m) = ddc_nb5_22[lev]; 
			    A(ind_m,ind_m-1)= ddc_nb5_23[lev]; 
			    A(ind_m,ind_m-2) = ddc_nb5_24[lev]; 
			    	    	    
			    A(ind_m,ind_m+1+str_m) = ddc_nb6_21[lev]; 
			    A(ind_m,ind_m+str_m) = ddc_nb6_22[lev]; 
			    A(ind_m,ind_m-1+str_m)= ddc_nb6_23[lev]; 
			    A(ind_m,ind_m-2+str_m) = ddc_nb6_24[lev];
			  ...
			  {	    
			    A(ind_m,ind_m-str_m) = ddc_b4_11[lev]; 
			    A(ind_m,ind_m-1-str_m) = ddc_b4_12[lev]; 
			    A(ind_m,ind_m-2-str_m) = ddc_b4_13[lev]; 
			    
			    A(ind_m,ind_m) = ddc_b5_11[lev]; 
			    A(ind_m,ind_m-1) = ddc_b5_12[lev]; 
			    A(ind_m,ind_m-2) = ddc_b5_13[lev]; 
			    
			    A(ind_m,ind_m+str_m) = ddc_b6_11[lev]; 
			    A(ind_m,ind_m-1+str_m) = ddc_b6_12[lev]; 
			    A(ind_m,ind_m-2+str_m) = ddc_b6_13[lev]; 
			    
			    A(ind_m,ind_m+2*str_m) = ddc_b7_11[lev]; 
			    A(ind_m,ind_m-1+2*str_m) = ddc_b7_12[lev]; 
			    A(ind_m,ind_m-2+2*str_m) = ddc_b7_13[lev];	       	  
			  }  
			}
			...
			if(j>=st_iny+2*sp && j<=en_iny-2*sp)
			{
			  ...
			  {	    			     	  			    
			    ...
			    A(ind_m,ind_m+1-str_m) = ddc_nb9_21[lev]; 
			    A(ind_m,ind_m-str_m) = ddc_nb9_22[lev]; 
			    A(ind_m,ind_m-1-str_m) = ddc_nb9_23[lev]; 
			    A(ind_m,ind_m-2-str_m) = ddc_nb9_24[lev];	
			    
			    A(ind_m,ind_m+1) = ddc_nb10_21[lev]; 
			    A(ind_m,ind_m) = ddc_nb10_22[lev]; 
			    A(ind_m,ind_m-1) = ddc_nb10_23[lev]; 
			    A(ind_m,ind_m-2) = ddc_nb10_24[lev];
			    
			    A(ind_m,ind_m+1+str_m) = ddc_nb11_21[lev]; 
			    A(ind_m,ind_m+str_m) = ddc_nb11_22[lev]; 
			    A(ind_m,ind_m-1+str_m) = ddc_nb11_23[lev]; 
			    A(ind_m,ind_m-2+str_m) = ddc_nb11_24[lev];
			  ...
			  {    			    		    
			    A(ind_m,ind_m-2*str_m) = ddc_b8_11[lev]; 
			    A(ind_m,ind_m-1-2*str_m) = ddc_b8_12[lev]; 
			    A(ind_m,ind_m-2-2*str_m) = ddc_b8_13[lev]; 
			    
			    A(ind_m,ind_m-str_m) = ddc_b9_11[lev]; 
			    A(ind_m,ind_m-1-str_m) = ddc_b9_12[lev]; 
			    A(ind_m,ind_m-2-str_m) = ddc_b9_13[lev];
			    
			    A(ind_m,ind_m) = ddc_b10_11[lev]; 
			    A(ind_m,ind_m-1) = ddc_b10_12[lev]; 
			    A(ind_m,ind_m-2) = ddc_b10_13[lev]; 
			    
			    A(ind_m,ind_m+str_m) = ddc_b11_11[lev]; 
			    A(ind_m,ind_m-1+str_m) = ddc_b11_12[lev]; 
			    A(ind_m,ind_m-2+str_m) = ddc_b11_13[lev]; 
			    
			    A(ind_m,ind_m+2*str_m) = ddc_b12_11[lev]; 
			    A(ind_m,ind_m-1+2*str_m) = ddc_b12_12[lev]; 
			    A(ind_m,ind_m-2+2*str_m) = ddc_b12_13[lev];		      
			  }	  	  
			}	
	...
	cout<<"The condition number of the trimmed matrix is   "<<cond(trim_A)<<"\n";
...
void compute_pbc(fval * fvar, pbcs& pbc, int up)	
{
	  ...
	  tdma1x(fvar,0);  //Evaluate du/dx at all points in the domain	  
	  
	  if(up==1) 
	  { 
	  	for(int i=0;i<=nx;i++) //Getting the pressure gradient in the top and bottom walls of the domain
	  	{    
	     		ind1 = i; 				     	//Bottom boundary
	     		ind2 = i + ny*str_x;      		     	//Top boundary
			
			pbc.p1y[i] = (1./Re)*fvar[ind1].uyy[1];  	//Bottom boundary
			pbc.p2y[i] = (1./Re)*fvar[ind2].uyy[1];  	//Top boundary*/
			
			/*pbc.p1y[i] = 0.0;  	//Bottom boundary //Both are Neumann BCs here
			pbc.p2y[i] = 0.0;  	//Top boundary*/ 		     		    	
	  	}
	  
	  	for(int j=0;j<=ny;j++) //Getting the pressure gradient at the left and right faces of the domain 
	  	{
	     		ind1 = j*str_x; 			    	//Left boundary
	     		ind2 = nx + j*str_x;			    	//Right boundary
	     
	     		/*pbc.p1x[j] = (1./Re)*( fvar[ind].uxx[0] + fvar[ind].uyy[0] );     				//Left boundary
	     		pbc.p2x[j] = -fvar[ind].u[1]*fvar[ind].uy[0] + (1./Re)*( fvar[ind].uxx[0] + fvar[ind].uyy[0] ); //Right boundary*/
	     		
	     		pbc.p1x[j] = (1./Re)*( fvar[ind1].uxx[0] + fvar[ind1].uyy[0] );     				//Left boundary
	     		
	     		pbc.p2x[j] = (1./Re)*fvar[ind2].ux[0] - (1./4.)*( (fvar[ind2].u[0]*fvar[ind2].u[0]) + (fvar[ind2].u[1]*fvar[ind2].u[1]) )*(1. - tanh(fvar[ind2].u[0]/delta)); //Dirichlet boundary condition from the paper by Dong et al
	     		
	     		//pbc.p2x[j] = 0.0; 
	     		
	     		/*pbc.p1x[j] = M_PI*cos(M_PI*j*dy);      //Left boundary
	     		pbc.p2x[j] = 0.0; 		         //Right boundary*/
	     		
	     		/*pbc.p1x[j] = 0.0;		      //Left boundary
	     		pbc.p2x[j] = -cos(M_PI*j*dy);*/	      //Right boundary
	     		
	     		/*pbc.p1x[j] = M_PI;     //Left boundary  //For problem with solution sin(M_PI*x)
	     		pbc.p2x[j] = 0.0;     //Right boundary //Dirichlet boundary value*/
	     		
	     		/*pbc.p1x[j] = 0.0;      //Left boundary  //For problem with solution cos(M_PI*y)
	     		pbc.p2x[j] = cos(M_PI*j*dy);     //Right boundary*/	//Dirichlet boundary value*/     			     		
	  	} 
	  }
	  else
	  {
...
void mg_bcs_neu(mg_grid * level,int lev, pbcs& pbc)
{
	...
	right.open("mg_right_wall.dat");*/ 
	 ...
	 for(int j=0;j<=ny;j=j+sp)
	 {
		...
		//level[lev].phi_s[ind] = 0.0; //Dirichlet BC for plane jet simulation
		
		level[lev].phi_s[ind] = pbc.p2x[j]; //Dirichlet BC for plane jet simulation
...
double error_calc(fval * fvar, int lev)
{
  ...
  for(int j=sp;j<ny;j=j+sp)
  {
    for(int i=sp;i<nx;i=i+sp)
    {
      ...
      //fvar[ind].err = fvar[ind].u[2] - sin(M_PI*i*dx)*cos(M_PI*j*dy); 
      
      fvar[ind].err = fvar[ind].u[2] - cos(M_PI*i*dx)*cos(M_PI*j*dy); 
      
      //fvar[ind].err = fvar[ind].u[2] - sin(M_PI*i*dx);
      
      //fvar[ind].err = fvar[ind].u[2] - cos(M_PI*j*dy);
...
void mg_bicgstab(mg_grid * level, int lev, int sm_ite, int up, int v_level, pbcs& pbc)
{
	...
	vec r0star=ones<vec>(tot_p_sol), ri(tot_p_sol), si(tot_p_sol), rip(tot_p_sol), pi(tot_p_sol), pip(tot_p_sol); 
	
	vec ub = zeros<vec>(tot_p_sol), ux(tot_p_sol), pcorrec_vec=ones<vec>(tot_p_sol), b(tot_p_sol), act_ub = zeros<vec>(tot_p_sol); 
	
	vec x=zeros<vec>(tot_p_sol), Api(tot_p_sol), Asi(tot_p_sol);
	
	vec error(tot_p_sol), efromr(tot_p_sol), diffine(tot_p_sol); 
	...
	for(int j=sp;j<=en_iny;j=j+sp)
	{
		for(int i=sp;i<=en_inx;i=i+sp)
		{
			...
			b(ind_m) = level[lev].rhs[ind];	//Untrimmed RHS	(Includes the last point)							
...
int st_size = 5; 	//Stencil size 
int num_points = 25; 
int num_coeff = 25; 

int sp=pow(2,lev); 

int i_start = i_in+sp;  //Start and end of the stencil indices 
int j_start = j_in+sp; 

int i_end = i_in+sp+4*sp; 
int j_end = j_in+sp+4*sp; 

int i_extra, j_extra, ind, ind_extra, ind_gl; 
double x, y, x_extra, y_extra;
...
mat point_col = zeros<mat>(num_coeff,1); 
...
coeff = solve(inter,rhs); 

//Preparing the interpolation polynomial for multiplication

x = x_extra; 
y = y_extra; 

point_col(0) = pow(x,4)*pow(y,4);
point_col(1) = pow(x,3)*pow(y,4);
point_col(2) = pow(x,2)*pow(y,4);
point_col(3) = x*pow(y,4);
point_col(4) = pow(y,4);
point_col(5) = pow(x,4)*pow(y,3);
point_col(6) = pow(x,3)*pow(y,3);
point_col(7) = pow(x,2)*pow(y,3); 
point_col(8) = x*pow(y,3);                      
point_col(9) = pow(y,3);
point_col(10) = pow(x,4)*pow(y,2);
point_col(11) = pow(x,3)*pow(y,2);
point_col(12) = pow(x,2)*pow(y,2);
point_col(13) = x*pow(y,2);
point_col(14) = pow(y,2);
point_col(15) = pow(x,4)*y;
point_col(16) = pow(x,3)*y;
point_col(17) = pow(x,2)*y;
point_col(18) = x*y;
point_col(19) = y; 
point_col(20) = pow(x,4);
point_col(21) = pow(x,3);
point_col(22) = pow(x,2);
point_col(23) = x;
point_col(24) = 1.0;	

return dot(coeff,point_col); 
}*/
/************************************************************************************************/

/************************************************************************************************/
//Function that designs an extrapolation formula using least squares method using a 4th order general polynomial in "X" and "Y" direction using only the interior points.  

//This is copied from the error_symmcheck case that's used to debug Scheme-2 numerics
...
if(i_in==0 && j_in==0)   //Bottom left corner 
{
	i_extra = 0;
	j_extra = 0; 
...
if(i_in==0 && j_in==ny-5*sp) //Top left corner
{
	i_extra=0;
	j_extra=4; 
...
if(i_in==nx-5*sp && j_in==ny-5*sp) //Top right corner 
{
	i_extra = 4; 
	j_extra = 4; 
...
if(i_in==nx-5*sp && j_in==0) //Bottom right corner
{
	i_extra = 4;
	j_extra = 0; 
...
/*********Printing all the indices*********/

/*cout<<"i_in = "<<i_in<<"   "<<"j_in = "<<j_in<<"\n"; 
cout<<"i_start = "<<i_start<<"	"<<"j_start = "<<j_start<<"\n"; 
cout<<"i_end = "<<i_end<<"	"<<"j_end = "<<j_end<<"\n"; 
cout<<"i_extra = "<<i_extra<<"	"<<"j_extra = "<<j_extra<<"\n";*/
...
//rhs.save("interpol_rhs.dat",raw_ascii); 

coeff = solve(inter,rhs); 

//coeff.save("interpol_coeff.dat",raw_ascii); 

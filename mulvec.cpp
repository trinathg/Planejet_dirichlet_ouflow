...
/*******************************************************************************/
//Mulvec function for NNND boundary domain. That is 3 Neumann and 1 Dirichlet. 
vec mulvec(vec X, mg_grid * level, int lev)
{ 	
	int sp=pow(2,lev), ind; 
	...
	for(int j=st_iny;j<=en_iny;j=j+sp)
	{
		for(int i=st_inx;i<=en_inx;i=i+sp)
		{
			...
			if(j==st_iny)
			{
			  ...
			  {	    	    	    	    
			    RHS1 = ddc_nb1_21[lev]*X[ind_m+1] + ddc_nb1_22[lev]*X[ind_m] + ddc_nb1_23[lev]*X[ind_m-1] + ddc_nb1_24[lev]*X[ind_m-2] ; 
			    
			    RHS2 = ddc_nb2_21[lev]*X[ind_m+1+str_m] + ddc_nb2_22[lev]*X[ind_m+str_m] + ddc_nb2_23[lev]*X[ind_m-1+str_m] + ddc_nb2_24[lev]*X[ind_m-2+str_m] ; 
			    
			    RHS3 = ddc_nb3_21[lev]*X[ind_m+1+2*str_m] + ddc_nb3_22[lev]*X[ind_m+2*str_m] + ddc_nb3_23[lev]*X[ind_m-1+2*str_m] + ddc_nb3_24[lev]*X[ind_m-2+2*str_m];  	    	    
			  ...
			  {	    	    	    
			    RHS1 = ddc_b1_11[lev]*X[ind_m] +  ddc_b1_12[lev]*X[ind_m-1] + ddc_b1_13[lev]*X[ind_m-2]; 
			    
			    RHS2 = ddc_b2_11[lev]*X[ind_m+str_m] + ddc_b2_12[lev]*X[ind_m-1+str_m] + ddc_b2_13[lev]*X[ind_m-2+str_m]; 
			    
			    RHS3 = ddc_b3_11[lev]*X[ind_m+2*str_m] + ddc_b3_12[lev]*X[ind_m-1+2*str_m] + ddc_b3_13[lev]*X[ind_m-2+2*str_m]; 	   	        
			...
			if(j==st_iny+sp)
			{
			  ...
			  {	    	    	    
			    RHS1 = ddc_nb4_21[lev]*X[ind_m+1-str_m] + ddc_nb4_22[lev]*X[ind_m-str_m] + ddc_nb4_23[lev]*X[ind_m-1-str_m] + ddc_nb4_24[lev]*X[ind_m-2-str_m]; 
			    
			    RHS2 = ddc_nb5_21[lev]*X[ind_m+1] + ddc_nb5_22[lev]*X[ind_m] + ddc_nb5_23[lev]*X[ind_m-1] + ddc_nb5_24[lev]*X[ind_m-2]; 
			    
			    RHS3 = ddc_nb6_21[lev]*X[ind_m+1+str_m] + ddc_nb6_22[lev]*X[ind_m+str_m] + ddc_nb6_23[lev]*X[ind_m-1+str_m] + ddc_nb6_24[lev]*X[ind_m-2+str_m]; 
			  ...
			  {	    	     	    
			    RHS1 = ddc_b4_11[lev]*X[ind_m-str_m] + ddc_b4_12[lev]*X[ind_m-1-str_m] + ddc_b4_13[lev]*X[ind_m-2-str_m] ; 	    
			    
			    RHS2 =  ddc_b5_11[lev]*X[ind_m] + ddc_b5_12[lev]*X[ind_m-1] + ddc_b5_13[lev]*X[ind_m-2]; 
			    
			    RHS3 = ddc_b6_11[lev]*X[ind_m+str_m] + ddc_b6_12[lev]*X[ind_m-1+str_m] + ddc_b6_13[lev]*X[ind_m-2+str_m];	    
			    
			    RHS4 = ddc_b7_11[lev]*X[ind_m+2*str_m] + ddc_b7_12[lev]*X[ind_m-1+2*str_m] + ddc_b7_13[lev]*X[ind_m-2+2*str_m]; 			    			    
			...
			//cout<<dc_b8_11[lev]<<"\n"<<dc_b8_12[lev]<<"\n"<<dc_b8_12[lev]<<"\n"<<dc_b9_11[lev]<<"\n"<<dc_b9_12[lev]<<"\n"<<dc_b9_13[lev]<<"\n"<<dc_b9_13[lev]<<"\n"<<dc_b9_12[lev]<<"\n"<<dc_b10_11[lev]<<"\n"<<dc_b10_12[lev]<<"\n"<<dc_b10_13[lev]<<"\n"<<dc_b10_13[lev]<<"\n"<<dc_b10_12[lev]<<"\n"<<dc_b11_11[lev]<<"\n"<<dc_b11_12[lev]<<"\n"<<dc_b11_13[lev]<<"\n"<<dc_b11_13[lev]<<"\n"<<dc_b11_12[lev]<<"\n"<<dc_b12_11[lev]<<"\n"<<dc_b12_12[lev]<<"\n"<<dc_b12_12[lev]<<"\n";
			  ...
			  {	    	     	    
			    ...
			    RHS2 = ddc_nb9_21[lev]*X[ind_m+1-str_m] + ddc_nb9_22[lev]*X[ind_m-str_m] + ddc_nb9_23[lev]*X[ind_m-1-str_m] + ddc_nb9_24[lev]*X[ind_m-2-str_m]; 
			    
			    RHS3 = ddc_nb10_21[lev]*X[ind_m+1] + ddc_nb10_22[lev]*X[ind_m] + ddc_nb10_23[lev]*X[ind_m-1] + ddc_nb10_24[lev]*X[ind_m-2]; 
			    
			    RHS4 = ddc_nb11_21[lev]*X[ind_m+1+str_m] + ddc_nb11_22[lev]*X[ind_m+str_m] + ddc_nb11_23[lev]*X[ind_m-1+str_m] + ddc_nb11_24[lev]*X[ind_m-2+str_m]; 	   			    
			  ...
			  {    	    	    
			    RHS1 = ddc_b8_11[lev]*X[ind_m-2*str_m] + ddc_b8_12[lev]*X[ind_m-1-2*str_m] + ddc_b8_13[lev]*X[ind_m-2-2*str_m]; 
			    
			    RHS2 = ddc_b9_11[lev]*X[ind_m-str_m] + ddc_b9_12[lev]*X[ind_m-1-str_m] + ddc_b9_13[lev]*X[ind_m-2-str_m]; 
			    
			    RHS3 = ddc_b10_11[lev]*X[ind_m] + ddc_b10_12[lev]*X[ind_m-1] + ddc_b10_13[lev]*X[ind_m-2]; 
			    
			    RHS4 = ddc_b11_11[lev]*X[ind_m+str_m] + ddc_b11_12[lev]*X[ind_m-1+str_m] + ddc_b11_13[lev]*X[ind_m-2+str_m]; 	    	    
			    
			    RHS5 = ddc_b12_11[lev]*X[ind_m+2*str_m] + ddc_b12_12[lev]*X[ind_m-1+2*str_m] + ddc_b12_13[lev]*X[ind_m-2+2*str_m];
			...
			if(j==en_iny-sp)
			{
			  ...
			  {	    	    	    
			    	RHS1 = ddc_nb4_21[lev]*X[ind_m+1+str_m] + ddc_nb4_22[lev]*X[ind_m+str_m] + ddc_nb4_23[lev]*X[ind_m-1+str_m] + ddc_nb4_24[lev]*X[ind_m-2+str_m]; //lcr 
			  ...
			  {	    	    	    
			    RHS1 = ddc_b4_11[lev]*X[ind_m+str_m] + ddc_b4_12[lev]*X[ind_m-1+str_m] + ddc_b4_13[lev]*X[ind_m-2+str_m];   	    //lcr
			...
			if(j==en_iny)
			{
			  ...
			  {    	    	   	    			   	        
			    RHS1 = ddc_nb1_21[lev]*X[ind_m+1] + ddc_nb1_22[lev]*X[ind_m] + ddc_nb1_23[lev]*X[ind_m-1] + ddc_nb1_24[lev]*X[ind_m-2]; 	//lcr 		   	    
